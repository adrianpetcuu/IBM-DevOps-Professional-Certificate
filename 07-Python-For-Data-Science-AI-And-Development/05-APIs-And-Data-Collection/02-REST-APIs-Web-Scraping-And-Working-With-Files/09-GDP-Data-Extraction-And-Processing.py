...
# EXERCISE 2: Modify the GDP column of the DataFrame, converting the value available in
# Million USD to Billion USD. Use the round() method of Numpy library to round the value to 2 decimal places.
